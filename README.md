...
1. 修复“搜索之后一直处于 loading 状态”（[模拟器和手机端微信的 new Date 格式不一样](https://www.cnblogs.com/dianzan/p/7782398.html)）；
2. 修复“点击日期在现有信息后面追加”问题（追加之前先清空）；
3. 修复“校招日历页面点击详情出错”问题;
4. 修复“信息详情页收藏按钮挡住正文”问题；
5. 修复“收藏按钮颜色不搭”；
6. 添加“信息详情页收藏图标”；
7. 添加“校招日历页日期选择下拉图标”；
8. 添加“个人中心->我的收藏”功能；
